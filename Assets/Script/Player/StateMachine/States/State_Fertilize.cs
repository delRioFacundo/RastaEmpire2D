...
public class State_Fertilize : IState
{
    Player _player;
    public State_Fertilize(Player player) { this._player = player; }

    public void EnterState()
    {
        _player.PreviusState = _player.CurrentState;
        _player.CurrentState = CurrentState.State_Fertilize;
        ...
        _player.player_Animation.SetFertilizing(true);
    ...
    {
        _player.player_Animation.SetFertilizing(false);
    }
