...
public class State_ProtectionSpray : IState
{
    Player _player;
    public State_ProtectionSpray(Player player) { this._player = player; }

    public void EnterState()
    {
        _player.PreviusState = _player.CurrentState;
        _player.CurrentState = CurrentState.State_ProtectionSpray;
        ...
        _player.player_Animation.SetProtectionSpray(true);
    ...
    {
        _player.player_Animation.SetProtectionSpray(false);
    }
